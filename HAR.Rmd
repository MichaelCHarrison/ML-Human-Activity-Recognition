...
The training dataset now conatains 48 numeric predictors and 1 factor outcome. The data preparation techniques to reduce the training set will be applied to the testing set before final model evaluation. As the testing dataset only contains 20 instances of activity, the expectation of the prediciton model will be to correctly classify each instance in the correct class. 
